.PHONY: all clean docker-baseimage docker-baseimage-jre17 docker-baseimage-jdk17-builder
...
all: docker-baseimage docker-baseimage-jre17 docker-baseimage-jdk17-builder
